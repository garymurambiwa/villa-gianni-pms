...
const VendorManagement: React.FC = () => {
  const { vendors, vendorExpenses, vendorPayments, addVendor, updateVendor, deleteVendor, addVendorExpense, updateVendorExpense, payVendor, loadVendorPayments } = useData();
