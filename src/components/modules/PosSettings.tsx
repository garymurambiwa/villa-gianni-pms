...
const [inventoryControlOpen, setInventoryControlOpen] = React.useState(false);
  ...
  React.useEffect(() => {
    ...
    hk.register('Shift+I', { tooltip: 'Open Inventory Items Viewer', handler: () => {
